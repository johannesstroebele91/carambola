...
export const quotes: Quote[] = [
    ...
    },
    {
        ...
        quote:
            "Women really do pay attention to a man’s glutes. A tight, compact ass is often voted even more desirable than a man’s arms or chest. So, if you’re lacking, start squatting!",
    },
    {
        id: 12,
        author: "Ronnie Coleman",
